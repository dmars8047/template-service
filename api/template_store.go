...
type TemplateStore interface {
	GetAllTemplates(name string) ([]tmpl.Template, error)
	GetTemplateById(templateId string) (*tmpl.Template, error)
	GetTemplatebyName(templateName string) (*tmpl.Template, error)
	CreateTemplate(template *tmpl.Template) error
...
func (store *MongoTemplateStore) GetAllTemplates(name string) ([]tmpl.Template, error) {
	filter := bson.M{}
	...
	var results []tmpl.Template = make([]tmpl.Template, 0)
...
func (store *MongoTemplateStore) GetTemplateById(templateId string) (*tmpl.Template, error) {
...
func (store *MongoTemplateStore) GetTemplatebyName(templateName string) (*tmpl.Template, error) {
...
func (store *MongoTemplateStore) CreateTemplate(template *tmpl.Template) error {
